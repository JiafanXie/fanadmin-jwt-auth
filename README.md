...
Thanks catchadmin and https://github.com/catch-admin/jwt-auth repositoriy
...
```shell
$ composer require dengje/jwt-auth
```
...
对于需要验证的路由或者模块添加中间件：
```php
 dengje\jwt\middleware\JWTAuth::class,
```
...
> 如果需要自动刷新，请使用中间件  dengje\jwt\middleware\JWTAuthAndRefresh::class,
