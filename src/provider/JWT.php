...
use FanAdmin\jwt\Blacklist;
use FanAdmin\jwt\claim\Factory;
use FanAdmin\jwt\facade\JWTAuth;
use FanAdmin\jwt\Manager;
use FanAdmin\jwt\parser\AuthHeader;
use FanAdmin\jwt\parser\Cookie;
use FanAdmin\jwt\parser\Param;
use FanAdmin\jwt\Payload;
use FanAdmin\jwt\provider\JWT\Lcobucci;
use think\Request;
